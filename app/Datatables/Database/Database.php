...
namespace App\Datatables\Database;

use
	App\Datatables\Database\Query,
	App\Datatables\Database\Result,
	App\Datatables\Database\Driver\Mysql\DriverMysqlQuery,
	App\Datatables\Database\Driver\Mysql\DriverMysqlResult;
...
class Database {
	...
	function __construct( $opts )
	{
		...
		$this->query_driver = "App\Datatables\\Database\\Driver\\Mysql\\Driver".$opts['type'].'Query';
