...
@section('title', 'Request for like')
       ...
       <div class="typography-line">
        ...
        <div class="row col-md-12 ml-auto mr-auto" id="medias">
          ...
          <div class="col-lg-4 col-md-4 col-xs-6">
            @if($max_count < 1)
               <h4> You can't request likes for this media. Please try again after some time. </h4>
            @else
              <form action="/likes/start" method="post">
                <div class="form-group">
                  <input type="hidden" name="_token" value="{{ csrf_token() }}">
                  <input type="hidden" name="media_id" value=" {{ $id }} ">
                  <label for="no_of_follower">Number of likes: <br>(Available likes: {{ $max_count }})</label>
                  <input type="number" class="form-control" name="count" id="no_of_follower" max="{{ $max_count }}" value="1" min="1" max="10">
                  </div>
